  ...
  return (
    currentUser ?
      <MenuTrigger>
        ...
        <Popover placement="bottom end" className={`${dark == false ? `bg-white text-black` : `bg-[#1C2833] text-white`} z-50 min-w-56 mt-2 rounded-xl shadow-xl border border-amber-500 p-1 -translate-y-0.5 sm:translate-x-0 translate-x-[33px]`}>
